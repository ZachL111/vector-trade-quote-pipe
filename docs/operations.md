...
`vector-trade-quote-pipe` is centered on trading systems work in Zig. The technical target is: Design a Zig verification harness for quote systems, covering storage recovery, log and snapshot fixtures, and failure-oriented tests.
...
The score is deterministic. The current threshold is 177. Risk has a penalty of 7, latency has a penalty of 3, and weight contributes a bonus of 5.
